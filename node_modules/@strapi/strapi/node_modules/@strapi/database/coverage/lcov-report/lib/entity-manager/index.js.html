...
<head>
    <title>Code coverage report for lib/entity-manager/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/entity-manager</a> index.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">4.56% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>19/416</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>0/326</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>19/408</span>
            </div>
...
<a name='L1250'></a><a href='#L1250'>1250</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
const toId = <span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; <span class="cstat-no" title="statement not covered" >value.id || value;</span>
const toIds = <span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; <span class="cstat-no" title="statement not covered" >castArray(value || []).map(toId);</span>
&nbsp;
const isValidId = <span class="fstat-no" title="function not covered" >(v</span>alue) =&gt; <span class="cstat-no" title="statement not covered" >isString(value) || isInteger(value);</span>
const toIdArray = <span class="fstat-no" title="function not covered" >(d</span>ata) =&gt; {
  const array = <span class="cstat-no" title="statement not covered" >castArray(data)</span>
    .filter(<span class="fstat-no" title="function not covered" >(d</span>atum) =&gt; <span class="cstat-no" title="statement not covered" >!isNil(datum))</span>
    .map(<span class="fstat-no" title="function not covered" >(d</span>atum) =&gt; {
      // if it is a string or an integer return an obj with id = to datum
<span class="cstat-no" title="statement not covered" >      if (isValidId(datum)) {</span>
<span class="cstat-no" title="statement not covered" >        return { id: datum, __pivot: {} };</span>
      }
&nbsp;
      // if it is an object check it has at least a valid id
<span class="cstat-no" title="statement not covered" >      if (!has('id', datum) || !isValidId(datum.id)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(`Invalid id, expected a string or integer, got ${datum}`);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return datum;</span>
    });
<span class="cstat-no" title="statement not covered" >  return uniqWith(isEqual, array);</span>
};
&nbsp;
const toAssocs = <span class="fstat-no" title="function not covered" >(d</span>ata) =&gt; {
<span class="cstat-no" title="statement not covered" >  if (isArray(data) || isString(data) || isNumber(data) || isNull(data) || data?.id) {</span>
<span class="cstat-no" title="statement not covered" >    return {</span>
      set: isNull(data) ? data : toIdArray(data),
    };
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (data?.set) {</span>
<span class="cstat-no" title="statement not covered" >    return {</span>
...
<span class="cstat-no" title="statement not covered" >  return {</span>
    ...
    connect: toIdArray(data?.connect).map(<span class="fstat-no" title="function not covered" >(e</span>lm) =&gt; (<span class="cstat-no" title="statement not covered" >{</span>
      id: elm.id,
...
&nbsp;
const processData = <span class="fstat-no" title="function not covered" >(m</span>etadata, data = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> { withDefaults = <span class="branch-0 cbranch-no" title="branch not covered" >false </span>} = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> =&gt; {
  const { attributes } = <span class="cstat-no" title="statement not covered" >metadata;</span>
&nbsp;
  const obj = <span class="cstat-no" title="statement not covered" >{};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (const attributeName of Object.keys(attributes)) {</span>
    const attribute = <span class="cstat-no" title="statement not covered" >attributes[attributeName];</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (isUndefined(data[attributeName])) {</span>
<span class="cstat-no" title="statement not covered" >        if (!isUndefined(attribute.default) &amp;&amp; withDefaults) {</span>
<span class="cstat-no" title="statement not covered" >          if (typeof attribute.default === 'function') {</span>
<span class="cstat-no" title="statement not covered" >            obj[attributeName] = attribute.default();</span>
          } else {
<span class="cstat-no" title="statement not covered" >            obj[attributeName] = attribute.default;</span>
          }
        }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (typeof field.validate === 'function' &amp;&amp; data[attributeName] !== null) {</span>
<span class="cstat-no" title="statement not covered" >        field.validate(data[attributeName]);</span>
      }
&nbsp;
      const val = <span class="cstat-no" title="statement not covered" >data[attributeName] === null ? null : field.toDB(data[attributeName]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      obj[attributeName] = val;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (types.isRelation(attribute.type)) {</span>
      // oneToOne &amp; manyToOne
<span class="cstat-no" title="statement not covered" >      if (attribute.joinColumn &amp;&amp; attribute.owner) {</span>
        const joinColumnName = <span class="cstat-no" title="statement not covered" >attribute.joinColumn.name;</span>
&nbsp;
        // allow setting to null
        const attrValue = <span class="cstat-no" title="statement not covered" >!isUndefined(data[attributeName])</span>
          ? data[attributeName]
          : data[joinColumnName];
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!isUndefined(attrValue)) {</span>
<span class="cstat-no" title="statement not covered" >          obj[joinColumnName] = attrValue;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        continue;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (attribute.morphColumn &amp;&amp; attribute.owner) {</span>
        const { idColumn, typeColumn, typeField = <span class="branch-0 cbranch-no" title="branch not covered" >'__type' </span>} = <span class="cstat-no" title="statement not covered" >attribute.morphColumn;</span>
&nbsp;
        const value = <span class="cstat-no" title="statement not covered" >data[attributeName];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          if (!has('id', value) || !has(typeField, value)) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error(`Expects properties ${typeField} an id to make a morph association`);</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          Object.assign(obj, {</span>
...
&nbsp;
  return {
<span class="fstat-no" title="function not covered" >    as</span>ync findOne(uid, params) {
      const states = <span class="cstat-no" title="statement not covered" >await db.lifecycles.run('beforeFindOne', uid, { params });</span>
&nbsp;
      const result = <span class="cstat-no" title="statement not covered" >await this.createQueryBuilder(uid).init(params).first().execute();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      await db.lifecycles.run('afterFindOne', uid, { params, result }, states);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return result;</span>
    },
&nbsp;
    // should we name it findOne because people are used to it ?
<span class="fstat-no" title="function not covered" >    as</span>ync findMany(uid, params) {
      const states = <span class="cstat-no" title="statement not covered" >await db.lifecycles.run('beforeFindMany', uid, { params });</span>
&nbsp;
      const result = <span class="cstat-no" title="statement not covered" >await this.createQueryBuilder(uid).init(params).execute();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      await db.lifecycles.run('afterFindMany', uid, { params, result }, states);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return result;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    as</span>ync count(uid, params) {
      const states = <span class="cstat-no" title="statement not covered" >await db.lifecycles.run('beforeCount', uid, { params });</span>
&nbsp;
      const res = <span class="cstat-no" title="statement not covered" >await this.createQueryBuilder(uid)</span>
        .init(pick(['_q', 'where', 'filters'], params))
        .count()
        .first()
        .execute();
&nbsp;
      const result = <span class="cstat-no" title="statement not covered" >Number(res.count);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      await db.lifecycles.run('afterCount', uid, { params, result }, states);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return result;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    as</span>ync create(uid, params = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
      const states = <span class="cstat-no" title="statement not covered" >await db.lifecycles.run('beforeCreate', uid, { params });</span>
&nbsp;
      const metadata = <span class="cstat-no" title="statement not covered" >db.metadata.get(uid);</span>
      const { data } = <span class="cstat-no" title="statement not covered" >params;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!isPlainObject(data)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Create expects a data object');</span>
      }
&nbsp;
      const dataToInsert = <span class="cstat-no" title="statement not covered" >processData(metadata, data, { withDefaults: true });</span>
&nbsp;
      const res = <span class="cstat-no" title="statement not covered" >await this.createQueryBuilder(uid).insert(dataToInsert).execute();</span>
&nbsp;
      const id = <span class="cstat-no" title="statement not covered" >res[0].id || res[0];</span>
&nbsp;
      const trx = <span class="cstat-no" title="statement not covered" >await strapi.db.transaction();</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        await this.attachRelations(uid, id, data, { transaction: trx.get() });</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        await trx.commit();</span>
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        await trx.rollback();</span>
<span class="cstat-no" title="statement not covered" >        await this.createQueryBuilder(uid).where({ id }).delete().execute();</span>
...
&nbsp;
      ...
      const result = <span class="cstat-no" title="statement not covered" >await this.findOne(uid, {</span>
        where: { id },
        select: params.select,
        populate: params.populate,
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      await db.lifecycles.run('afterCreate', uid, { params, result }, states);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return result;</span>
    },
&nbsp;
    // TODO: where do we handle relation processing for many queries ?
<span class="fstat-no" title="function not covered" >    as</span>ync createMany(uid, params = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
      const states = <span class="cstat-no" title="statement not covered" >await db.lifecycles.run('beforeCreateMany', uid, { params });</span>
&nbsp;
      const metadata = <span class="cstat-no" title="statement not covered" >db.metadata.get(uid);</span>
      const { data } = <span class="cstat-no" title="statement not covered" >params;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!isArray(data)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('CreateMany expects data to be an array');</span>
      }
&nbsp;
      const dataToInsert = <span class="cstat-no" title="statement not covered" >data.map(<span class="fstat-no" title="function not covered" >(d</span>atum) =&gt;</span>
<span class="cstat-no" title="statement not covered" >        processData(metadata, datum, { withDefaults: true })</span>
      );
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (isEmpty(dataToInsert)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Nothing to insert');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      await this.createQueryBuilder(uid).insert(dataToInsert).execute();</span>
&nbsp;
      const result = <span class="cstat-no" title="statement not covered" >{ count: data.length };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      await db.lifecycles.run('afterCreateMany', uid, { params, result }, states);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return result;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    as</span>ync update(uid, params = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
      const states = <span class="cstat-no" title="statement not covered" >await db.lifecycles.run('beforeUpdate', uid, { params });</span>
&nbsp;
      const metadata = <span class="cstat-no" title="statement not covered" >db.metadata.get(uid);</span>
      const { where, data } = <span class="cstat-no" title="statement not covered" >params;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!isPlainObject(data)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Update requires a data object');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (isEmpty(where)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Update requires a where parameter');</span>
      }
&nbsp;
      const entity = <span class="cstat-no" title="statement not covered" >await this.createQueryBuilder(uid)</span>
        .select('*')
        .where(where)
        .first()
...
&nbsp;
      const { id } = <span class="cstat-no" title="statement not covered" >entity;</span>
&nbsp;
      const dataToUpdate = <span class="cstat-no" title="statement not covered" >processData(metadata, data);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!isEmpty(dataToUpdate)) {</span>
<span class="cstat-no" title="statement not covered" >        await this.createQueryBuilder(uid).where({ id }).update(dataToUpdate).execute();</span>
      }
&nbsp;
      const trx = <span class="cstat-no" title="statement not covered" >await strapi.db.transaction();</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        await this.updateRelations(uid, id, data, { transaction: trx.get() });</span>
<span class="cstat-no" title="statement not covered" >        await trx.commit();</span>
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        await trx.rollback();</span>
<span class="cstat-no" title="statement not covered" >        await this.createQueryBuilder(uid).where({ id }).update(entity).execute();</span>
<span class="cstat-no" title="statement not covered" >        throw e;</span>
      }
&nbsp;
      // TODO: do not trigger the findOne lifecycles ?
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      await db.lifecycles.run('afterUpdate', uid, { params, result }, states);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return result;</span>
    },
&nbsp;
    // TODO: where do we handle relation processing for many queries ?
<span class="fstat-no" title="function not covered" >    as</span>ync updateMany(uid, params = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
      const states = <span class="cstat-no" title="statement not covered" >await db.lifecycles.run('beforeUpdateMany', uid, { params });</span>
&nbsp;
      const metadata = <span class="cstat-no" title="statement not covered" >db.metadata.get(uid);</span>
      const { where, data } = <span class="cstat-no" title="statement not covered" >params;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (isEmpty(dataToUpdate)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Update requires data');</span>
      }
&nbsp;
      const updatedRows = <span class="cstat-no" title="statement not covered" >await this.createQueryBuilder(uid)</span>
        .where(where)
        .update(dataToUpdate)
        .execute();
&nbsp;
      const result = <span class="cstat-no" title="statement not covered" >{ count: updatedRows };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      await db.lifecycles.run('afterUpdateMany', uid, { params, result }, states);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return result;</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    as</span>ync delete(uid, params = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
      const states = <span class="cstat-no" title="statement not covered" >await db.lifecycles.run('beforeDelete', uid, { params });</span>
&nbsp;
      const { where, select, populate } = <span class="cstat-no" title="statement not covered" >params;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (isEmpty(where)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Delete requires a where parameter');</span>
      }
&nbsp;
      // TODO: do not trigger the findOne lifecycles ?
      const entity = <span class="cstat-no" title="statement not covered" >await this.findOne(uid, {</span>
...
&nbsp;
      const trx = <span class="cstat-no" title="statement not covered" >await strapi.db.transaction();</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        await this.deleteRelations(uid, id, { transaction: trx.get() });</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        await trx.commit();</span>
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        await trx.rollback();</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      await db.lifecycles.run('afterDelete', uid, { params, result: entity }, states);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return entity;</span>
    },
&nbsp;
    // TODO: where do we handle relation processing for many queries ?
<span class="fstat-no" title="function not covered" >    as</span>ync deleteMany(uid, params = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
      const states = <span class="cstat-no" title="statement not covered" >await db.lifecycles.run('beforeDeleteMany', uid, { params });</span>
&nbsp;
      const { where } = <span class="cstat-no" title="statement not covered" >params;</span>
&nbsp;
      const deletedRows = <span class="cstat-no" title="statement not covered" >await this.createQueryBuilder(uid).where(where).delete().execute();</span>
&nbsp;
      const result = <span class="cstat-no" title="statement not covered" >{ count: deletedRows };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      await db.lifecycles.run('afterDeleteMany', uid, { params, result }, states);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return result;</span>
    },
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    as</span>ync attachRelations(uid, id, data, { transaction: trx }) {
      const { attributes } = <span class="cstat-no" title="statement not covered" >db.metadata.get(uid);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (const attributeName of Object.keys(attributes)) {</span>
        const attribute = <span class="cstat-no" title="statement not covered" >attributes[attributeName];</span>
&nbsp;
        const isValidLink = <span class="cstat-no" title="statement not covered" >has(attributeName, data) &amp;&amp; !isNil(data[attributeName]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (attribute.type !== 'relation' || !isValidLink) {</span>
<span class="cstat-no" title="statement not covered" >          continue;</span>
        }
&nbsp;
        const cleanRelationData = <span class="cstat-no" title="statement not covered" >toAssocs(data[attributeName]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (attribute.relation === 'morphOne' || attribute.relation === 'morphMany') {</span>
          const { target, morphBy } = <span class="cstat-no" title="statement not covered" >attribute;</span>
&nbsp;
          const targetAttribute = <span class="cstat-no" title="statement not covered" >db.metadata.get(target).attributes[morphBy];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (targetAttribute.relation === 'morphToOne') {</span>
            // set columns
            const { idColumn, typeColumn } = <span class="cstat-no" title="statement not covered" >targetAttribute.morphColumn;</span>
&nbsp;
            const relId = <span class="cstat-no" title="statement not covered" >toId(cleanRelationData.set[0]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            await this.createQueryBuilder(target)</span>
              .update({ [idColumn.name]: id, [typeColumn.name]: uid })
              .where({ id: relId })
              .transacting(trx)
              .execute();
          } else <span class="cstat-no" title="statement not covered" >if (targetAttribute.relation === 'morphToMany') {</span>
            const { joinTable } = <span class="cstat-no" title="statement not covered" >targetAttribute;</span>
            const { joinColumn, morphColumn } = <span class="cstat-no" title="statement not covered" >joinTable;</span>
&nbsp;
            const { idColumn, typeColumn } = <span class="cstat-no" title="statement not covered" >morphColumn;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (isEmpty(cleanRelationData.set)) {</span>
<span class="cstat-no" title="statement not covered" >              continue;</span>
            }
&nbsp;
            const rows = <span class="cstat-no" title="statement not covered" >cleanRelationData.set.map(<span class="fstat-no" title="function not covered" >(d</span>ata, idx) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >              return {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            await this.createQueryBuilder(joinTable.name).insert(rows).transacting(trx).execute();</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          continue;</span>
        } else <span class="cstat-no" title="statement not covered" >if (attribute.relation === 'morphToOne') {</span>
          // handled on the entry itself
<span class="cstat-no" title="statement not covered" >          continue;</span>
        } else <span class="cstat-no" title="statement not covered" >if (attribute.relation === 'morphToMany') {</span>
          const { joinTable } = <span class="cstat-no" title="statement not covered" >attribute;</span>
          const { joinColumn, morphColumn } = <span class="cstat-no" title="statement not covered" >joinTable;</span>
&nbsp;
          const { idColumn, typeColumn, typeField = <span class="branch-0 cbranch-no" title="branch not covered" >'__type' </span>} = <span class="cstat-no" title="statement not covered" >morphColumn;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (isEmpty(cleanRelationData.set)) {</span>
<span class="cstat-no" title="statement not covered" >            continue;</span>
          }
&nbsp;
          const rows = <span class="cstat-no" title="statement not covered" >cleanRelationData.set.map(<span class="fstat-no" title="function not covered" >(d</span>ata, idx) =&gt; (<span class="cstat-no" title="statement not covered" >{</span></span>
            [joinColumn.name]: id,
...
<span class="cstat-no" title="statement not covered" >          await deleteRelatedMorphOneRelationsAfterMorphToManyUpdate(rows, {</span>
            uid,
            attributeName,
            joinTable,
            db,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (attribute.joinColumn &amp;&amp; attribute.owner) {</span>
          const relIdsToAdd = <span class="cstat-no" title="statement not covered" >toIds(cleanRelationData.set);</span>
<span class="cstat-no" title="statement not covered" >          if (</span>
            attribute.relation === 'oneToOne' &amp;&amp;
            isBidirectional(attribute) &amp;&amp;
            relIdsToAdd.length
          ) {
<span class="cstat-no" title="statement not covered" >            await this.createQueryBuilder(uid)</span>
...
<span class="cstat-no" title="statement not covered" >        if (attribute.joinColumn &amp;&amp; !attribute.owner) {</span>
          ...
          const { target } = <span class="cstat-no" title="statement not covered" >attribute;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (attribute.joinTable) {</span>
          // need to set the column on the target
&nbsp;
          const { joinTable } = <span class="cstat-no" title="statement not covered" >attribute;</span>
          const { joinColumn, inverseJoinColumn, orderColumnName, inverseOrderColumnName } =
<span class="cstat-no" title="statement not covered" >            joinTable;</span>
&nbsp;
          const relsToAdd = <span class="cstat-no" title="statement not covered" >cleanRelationData.set || cleanRelationData.connect;</span>
          const relIdsToadd = <span class="cstat-no" title="statement not covered" >toIds(relsToAdd);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (isBidirectional(attribute) &amp;&amp; isOneToAny(attribute)) {</span>
<span class="cstat-no" title="statement not covered" >            await deletePreviousOneToAnyRelations({</span>
              id,
              attribute,
              relIdsToadd,
              db,
...
&nbsp;
          ...
          const insert = <span class="cstat-no" title="statement not covered" >uniqBy('id', relsToAdd).map(<span class="fstat-no" title="function not covered" >(d</span>ata) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            return {</span>
              [joinColumn.name]: id,
...
&nbsp;
          // add order value
<span class="cstat-no" title="statement not covered" >          if (cleanRelationData.set &amp;&amp; hasOrderColumn(attribute)) {</span>
<span class="cstat-no" title="statement not covered" >            insert.forEach(<span class="fstat-no" title="function not covered" >(d</span>ata, idx) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >              data[orderColumnName] = idx + 1;</span>
            });
          } else <span class="cstat-no" title="statement not covered" >if (cleanRelationData.connect &amp;&amp; hasOrderColumn(attribute)) {</span>
            // use position attributes to calculate order
            const orderMap = <span class="cstat-no" title="statement not covered" >relationsOrderer(</span>
              [],
              ...
              .reduce(<span class="fstat-no" title="function not covered" >(a</span>cc, rel, idx) =&gt; (<span class="cstat-no" title="statement not covered" >{ ...acc, [rel.id]: idx })</span>, {});
&nbsp;
<span class="cstat-no" title="statement not covered" >            insert.forEach(<span class="fstat-no" title="function not covered" >(r</span>ow) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >              row[orderColumnName] = orderMap[row[inverseJoinColumn.name]];</span>
            });
          }
&nbsp;
          // add inv_order value
<span class="cstat-no" title="statement not covered" >          if (hasInverseOrderColumn(attribute)) {</span>
            const maxResults = <span class="cstat-no" title="statement not covered" >await db</span>
              .getConnection()
              ...
              .transacting(trx);
&nbsp;
            const maxMap = <span class="cstat-no" title="statement not covered" >maxResults.reduce(</span>
<span class="fstat-no" title="function not covered" >              (a</span>cc, res) =&gt; <span class="cstat-no" title="statement not covered" >Object.assign(acc, { [res[inverseJoinColumn.name]]: res.max }),</span>
              {}
            );
&nbsp;
<span class="cstat-no" title="statement not covered" >            insert.forEach(<span class="fstat-no" title="function not covered" >(r</span>el) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >              rel[inverseOrderColumnName] = (maxMap[rel[inverseJoinColumn.name]] || 0) + 1;</span>
            });
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (insert.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >            continue;</span>
          }
&nbsp;
          // insert new relations
<span class="cstat-no" title="statement not covered" >          await this.createQueryBuilder(joinTable.name).insert(insert).transacting(trx).execute();</span>
        }
      }
    },
&nbsp;
...
<span class="fstat-no" title="function not covered" >    as</span>ync updateRelations(uid, id, data, { transaction: trx }) {
      const { attributes } = <span class="cstat-no" title="statement not covered" >db.metadata.get(uid);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (const attributeName of Object.keys(attributes)) {</span>
        const attribute = <span class="cstat-no" title="statement not covered" >attributes[attributeName];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (attribute.type !== 'relation' || !has(attributeName, data)) {</span>
<span class="cstat-no" title="statement not covered" >          continue;</span>
        }
        const cleanRelationData = <span class="cstat-no" title="statement not covered" >toAssocs(data[attributeName]);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            await this.createQueryBuilder(target)</span>
              ...
              .execute();
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!isNull(cleanRelationData.set)) {</span>
              const relId = <span class="cstat-no" title="statement not covered" >toIds(cleanRelationData.set[0]);</span>
<span class="cstat-no" title="statement not covered" >              await this.createQueryBuilder(target)</span>
                .update({ [idColumn.name]: id, [typeColumn.name]: uid })
                .where({ id: relId })
                .transacting(trx)
...
&nbsp;
            const { idColumn, typeColumn } = <span class="cstat-no" title="statement not covered" >morphColumn;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            await this.createQueryBuilder(joinTable.name)</span>
              .delete()
              .where({
                [idColumn.name]: id,
                [typeColumn.name]: uid,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (attribute.relation === 'morphToOne') {</span>
          // handled on the entry itself
<span class="cstat-no" title="statement not covered" >          continue;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (attribute.relation === 'morphToMany') {</span>
          const { joinTable } = <span class="cstat-no" title="statement not covered" >attribute;</span>
          const { joinColumn, morphColumn } = <span class="cstat-no" title="statement not covered" >joinTable;</span>
&nbsp;
          const { idColumn, typeColumn, typeField = <span class="branch-0 cbranch-no" title="branch not covered" >'__type' </span>} = <span class="cstat-no" title="statement not covered" >morphColumn;</span>
...
<span class="cstat-no" title="statement not covered" >        if (attribute.joinTable) {</span>
          ...
          const { joinColumn, inverseJoinColumn, orderColumnName, inverseOrderColumnName } =
<span class="cstat-no" title="statement not covered" >            joinTable;</span>
          const select = <span class="cstat-no" title="statement not covered" >[joinColumn.name, inverseJoinColumn.name];</span>
<span class="cstat-no" title="statement not covered" >          if (hasOrderColumn(attribute)) {</span>
<span class="cstat-no" title="statement not covered" >            select.push(orderColumnName);</span>
          }
<span class="cstat-no" title="statement not covered" >          if (hasInverseOrderColumn(attribute)) {</span>
<span class="cstat-no" title="statement not covered" >            select.push(inverseOrderColumnName);</span>
          }
&nbsp;
          // only delete relations
<span class="cstat-no" title="statement not covered" >          if (isNull(cleanRelationData.set)) {</span>
<span class="cstat-no" title="statement not covered" >            await deleteRelations({ id, attribute, db, relIdsToDelete: 'all', transaction: trx });</span>
          } else {
            const isPartialUpdate = <span class="cstat-no" title="statement not covered" >!has('set', cleanRelationData);</span>
            let relIdsToaddOrMove;
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (isPartialUpdate) {</span>
<span class="cstat-no" title="statement not covered" >              if (isAnyToOne(attribute)) {</span>
<span class="cstat-no" title="statement not covered" >                cleanRelationData.connect = cleanRelationData.connect.slice(-1);</span>
              }
<span class="cstat-no" title="statement not covered" >              relIdsToaddOrMove = toIds(cleanRelationData.connect);</span>
              const relIdsToDelete = <span class="cstat-no" title="statement not covered" >toIds(</span>
                differenceWith(isEqual, cleanRelationData.disconnect, cleanRelationData.connect)
              );
&nbsp;
<span class="cstat-no" title="statement not covered" >              if (!isEmpty(relIdsToDelete)) {</span>
<span class="cstat-no" title="statement not covered" >                await deleteRelations({ id, attribute, db, relIdsToDelete, transaction: trx });</span>
              }
&nbsp;
<span class="cstat-no" title="statement not covered" >              if (isEmpty(cleanRelationData.connect)) {</span>
<span class="cstat-no" title="statement not covered" >                continue;</span>
              }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                currentMovingRels = await this.createQueryBuilder(joinTable.name)</span>
                  .select(select)
                  .where({
                    [joinColumn.name]: id,
...
&nbsp;
              ...
              const insert = <span class="cstat-no" title="statement not covered" >uniqBy('id', cleanRelationData.connect).map(<span class="fstat-no" title="function not covered" >(r</span>elToAdd) =&gt; (<span class="cstat-no" title="statement not covered" >{</span></span>
                [joinColumn.name]: id,
...
<span class="cstat-no" title="statement not covered" >              if (hasOrderColumn(attribute)) {</span>
                ...
                const adjacentRelations = <span class="cstat-no" title="statement not covered" >await this.createQueryBuilder(joinTable.name)</span>
                  .where({
                    $or: [
                      {
                        [joinColumn.name]: id,
...
<span class="fstat-no" title="function not covered" >                              (r</span>) =&gt; <span class="cstat-no" title="statement not covered" >r.position?.after || r.position?.before</span>
                            )
                          ),
                        },
                      },
...
&nbsp;
              // add inv order value
<span class="cstat-no" title="statement not covered" >              if (hasInverseOrderColumn(attribute)) {</span>
                const nonExistingRelsIds = <span class="cstat-no" title="statement not covered" >difference(</span>
                  relIdsToaddOrMove,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                insert.forEach(<span class="fstat-no" title="function not covered" >(r</span>ow) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                  row[inverseOrderColumnName] = (maxMap[row[inverseJoinColumn.name]] || 0) + 1;</span>
                });
              }
&nbsp;
              // insert rows
              const query = <span class="cstat-no" title="statement not covered" >this.createQueryBuilder(joinTable.name)</span>
                .insert(insert)
                .onConflict(joinTable.pivotColumns)
                .transacting(trx);
&nbsp;
<span class="cstat-no" title="statement not covered" >              if (hasOrderColumn(attribute)) {</span>
<span class="cstat-no" title="statement not covered" >                query.merge([orderColumnName]);</span>
              } else {
<span class="cstat-no" title="statement not covered" >                query.ignore();</span>
              }
&nbsp;
<span class="cstat-no" title="statement not covered" >              await query.execute();</span>
&nbsp;
              // remove gap between orders
<span class="cstat-no" title="statement not covered" >              await cleanOrderColumns({ attribute, db, id, transaction: trx });</span>
            } else {
<span class="cstat-no" title="statement not covered" >              if (isAnyToOne(attribute)) {</span>
<span class="cstat-no" title="statement not covered" >                cleanRelationData.set = cleanRelationData.set.slice(-1);</span>
              }
              // overwrite all relations
<span class="cstat-no" title="statement not covered" >              relIdsToaddOrMove = toIds(cleanRelationData.set);</span>
<span class="cstat-no" title="statement not covered" >              await deleteRelations({</span>
                id,
                attribute,
                db,
                relIdsToDelete: 'all',
...
&nbsp;
              const insert = <span class="cstat-no" title="statement not covered" >uniqBy('id', cleanRelationData.set).map(<span class="fstat-no" title="function not covered" >(r</span>elToAdd) =&gt; (<span class="cstat-no" title="statement not covered" >{</span></span>
                [joinColumn.name]: id,
                [inverseJoinColumn.name]: relToAdd.id,
                ...(joinTable.on || {}),
                ...(relToAdd.__pivot || {}),
...
&nbsp;
              // add order value
<span class="cstat-no" title="statement not covered" >              if (hasOrderColumn(attribute)) {</span>
<span class="cstat-no" title="statement not covered" >                insert.forEach(<span class="fstat-no" title="function not covered" >(r</span>ow, idx) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                  row[orderColumnName] = idx + 1;</span>
                });
              }
&nbsp;
              // add inv order value
<span class="cstat-no" title="statement not covered" >              if (hasInverseOrderColumn(attribute)) {</span>
                const existingRels = <span class="cstat-no" title="statement not covered" >await this.createQueryBuilder(joinTable.name)</span>
                  .select(inverseJoinColumn.name)
                  .where({
                    [joinColumn.name]: id,
                    [inverseJoinColumn.name]: { $in: relIdsToaddOrMove },
...
<span class="cstat-no" title="statement not covered" >            if (isAnyToOne(attribute)) {</span>
<span class="cstat-no" title="statement not covered" >              await deletePreviousAnyToOneRelations({</span>
                id,
                attribute,
...
&nbsp;
     ...
     * @param {ID} id - entity ID
     */
<span class="fstat-no" title="function not covered" >    as</span>ync deleteRelations(uid, id, { transaction: trx }) {
      const { attributes } = <span class="cstat-no" title="statement not covered" >db.metadata.get(uid);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (const attributeName of Object.keys(attributes)) {</span>
        const attribute = <span class="cstat-no" title="statement not covered" >attributes[attributeName];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (attribute.type !== 'relation') {</span>
<span class="cstat-no" title="statement not covered" >          continue;</span>
        }
&nbsp;
        /*
...
<span class="cstat-no" title="statement not covered" >            await this.createQueryBuilder(target)</span>
            ...
            const { joinTable } = <span class="cstat-no" title="statement not covered" >targetAttribute;</span>
            const { morphColumn } = <span class="cstat-no" title="statement not covered" >joinTable;</span>
&nbsp;
            const { idColumn, typeColumn } = <span class="cstat-no" title="statement not covered" >morphColumn;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            await this.createQueryBuilder(joinTable.name)</span>
...
<span class="cstat-no" title="statement not covered" >        if (attribute.relation === 'morphToMany') {</span>
          const { joinTable } = <span class="cstat-no" title="statement not covered" >attribute;</span>
          const { joinColumn } = <span class="cstat-no" title="statement not covered" >joinTable;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          await this.createQueryBuilder(joinTable.name)</span>
            .delete()
            .where({
...
<span class="cstat-no" title="statement not covered" >        if (db.dialect.usesForeignKeys()) {</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
&nbsp;
...
<span class="fstat-no" title="function not covered" >    as</span>ync populate(uid, entity, populate) {
      const entry = <span class="cstat-no" title="statement not covered" >await this.findOne(uid, {</span>
        select: ['id'],
        where: { id: entity.id },
        populate,
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      return { ...entity, ...entry };</span>
    },
&nbsp;
    // TODO: add lifecycle events
<span class="fstat-no" title="function not covered" >    as</span>ync load(uid, entity, fields, params) {
      const { attributes } = <span class="cstat-no" title="statement not covered" >db.metadata.get(uid);</span>
&nbsp;
      const fieldsArr = <span class="cstat-no" title="statement not covered" >castArray(fields);</span>
<span class="cstat-no" title="statement not covered" >      fieldsArr.forEach(<span class="fstat-no" title="function not covered" >(f</span>ield) =&gt; {</span>
        const attribute = <span class="cstat-no" title="statement not covered" >attributes[field];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!attribute || attribute.type !== 'relation') {</span>
<span class="cstat-no" title="statement not covered" >          throw new Error(`Invalid load. Expected ${field} to be a relational attribute`);</span>
        }
      });
&nbsp;
      const entry = <span class="cstat-no" title="statement not covered" >await this.findOne(uid, {</span>
        select: ['id'],
        where: { id: entity.id },
        populate: fieldsArr.reduce(<span class="fstat-no" title="function not covered" >(a</span>cc, field) =&gt; {
<span class="cstat-no" title="statement not covered" >          acc[field] = params || true;</span>
...
<span class="cstat-no" title="statement not covered" >        return pick(fields, entry);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return entry[fields];</span>
    },
&nbsp;
    // cascading
    // aggregations
...
&nbsp;
    ...
    // -&gt; private
&nbsp;
<span class="fstat-no" title="function not covered" >    cr</span>eateQueryBuilder(uid) {
<span class="cstat-no" title="statement not covered" >      return createQueryBuilder(uid, db);</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    ge</span>tRepository(uid) {
<span class="cstat-no" title="statement not covered" >      if (!repoMap[uid]) {</span>
<span class="cstat-no" title="statement not covered" >        repoMap[uid] = createRepository(uid, db);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return repoMap[uid];</span>
    },
&nbsp;
<span class="fstat-no" title="function not covered" >    cl</span>earRepositories() {
<span class="cstat-no" title="statement not covered" >      repoMap.clear();</span>
    },
  };
};
&nbsp;
