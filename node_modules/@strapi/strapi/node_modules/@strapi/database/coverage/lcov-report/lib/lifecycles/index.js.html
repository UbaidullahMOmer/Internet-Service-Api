...
<head>
    <title>Code coverage report for lib/lifecycles/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/lifecycles</a> index.js</h1>
        <div class='clearfix'>
...
&nbsp;
      return <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >subscribers.splice(subscribers.indexOf(subscriber), 1);</span>
    },
&nbsp;
    clear() {
      subscribers = [];
...
&nbsp;
    ...
    async run(action, uid, properties, states = new Map()) {
      for (let i = 0; i &lt; subscribers.length; i += 1) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof subscriber === 'function') {
          const state = <span class="cstat-no" title="statement not covered" >states.get(subscriber) || {};</span>
          const event = <span class="cstat-no" title="statement not covered" >this.createEvent(action, uid, properties, state);</span>
<span class="cstat-no" title="statement not covered" >          await subscriber(event);</span>
<span class="cstat-no" title="statement not covered" >          if (event.state) {</span>
<span class="cstat-no" title="statement not covered" >            states.set(subscriber, event.state || state);</span>
          }
<span class="cstat-no" title="statement not covered" >          continue;</span>
        }
&nbsp;
        const hasAction = action in subscriber;
        const hasModel = !subscriber.models || <span class="branch-1 cbranch-no" title="branch not covered" >subscriber.models.includes(uid);</span>
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (hasAction &amp;&amp; hasModel) {
