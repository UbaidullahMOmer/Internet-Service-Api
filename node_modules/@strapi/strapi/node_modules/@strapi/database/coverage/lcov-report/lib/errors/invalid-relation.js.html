...
<head>
    <title>Code coverage report for lib/errors/invalid-relation.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/errors</a> invalid-relation.js</h1>
        <div class='clearfix'>
...
class InvalidRelationError extends DatabaseError {
  constructor(message) {
    ...
    this.message = message || <span class="branch-1 cbranch-no" title="branch not covered" >'Invalid relation format';</span>
    this.details = {};
  }
}
&nbsp;
