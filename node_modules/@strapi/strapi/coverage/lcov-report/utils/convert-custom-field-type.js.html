...
<head>
    <title>Code coverage report for utils/convert-custom-field-type.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">utils</a> convert-custom-field-type.js</h1>
        <div class='clearfix'>
...
&nbsp;
  for (const schemaAttrbutes of allSchemasAttributes) {
    for (const attribute of Object.values(schemaAttrbutes)) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (attribute.type === 'customField') {
