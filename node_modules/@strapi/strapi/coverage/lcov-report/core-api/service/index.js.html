...
<head>
    <title>Code coverage report for core-api/service/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">core-api/service</a> index.js</h1>
        <div class='clearfix'>
 ...
 * @returns
 */
const getFetchParams = (params = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> =&gt; {
  return {
