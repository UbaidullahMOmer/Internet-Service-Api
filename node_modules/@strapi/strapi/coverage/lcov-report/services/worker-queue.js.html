...
<head>
    <title>Code coverage report for services/worker-queue.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">services</a> worker-queue.js</h1>
        <div class='clearfix'>
...
module.exports = class WorkerQueue {
  constructor({ logger, concurrency = <span class="branch-0 cbranch-no" title="branch not covered" >5 </span>} = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
