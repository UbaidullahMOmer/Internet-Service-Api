...
<head>
    <title>Code coverage report for services/content-api/permissions/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">services/content-api/permissions</a> index.js</h1>
        <div class='clearfix'>
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isEmpty(contentApiActions)) {
