...
<head>
    <title>Code coverage report for services/fs.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">services</a> fs.js</h1>
        <div class='clearfix'>
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    re</span>moveAppFile(optPath) {
      const removePath = <span class="cstat-no" title="statement not covered" >normalizePath(optPath);</span>
<span class="cstat-no" title="statement not covered" >      return fse.remove(removePath);</span>
    },
&nbsp;
    /**
     * Appends a file in strapi app
     */
<span class="fstat-no" title="function not covered" >    ap</span>pendFile(optPath, data) {
      const writePath = <span class="cstat-no" title="statement not covered" >normalizePath(optPath);</span>
<span class="cstat-no" title="statement not covered" >      return fse.appendFileSync(writePath, data);</span>
    },
  };
&nbsp;
  return strapiFS;
