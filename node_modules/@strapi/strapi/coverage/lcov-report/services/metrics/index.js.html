...
<head>
    <title>Code coverage report for services/metrics/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">services/metrics</a> index.js</h1>
        <div class='clearfix'>
...
&nbsp;
  return {
<span class="fstat-no" title="function not covered" >    ge</span>t isDisabled() {
<span class="cstat-no" title="statement not covered" >      return isDisabled;</span>
    },
&nbsp;
    register() {
      if (!isDisabled) {
        const pingCron = scheduleJob('0 0 12 * * *', <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >sendEvent('ping'))</span>;
        crons.push(pingCron);
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >    bo</span>otstrap() {},
&nbsp;
    destroy() {
      // Clear open handles
