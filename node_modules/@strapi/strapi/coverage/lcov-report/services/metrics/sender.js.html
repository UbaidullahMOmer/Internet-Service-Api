...
<head>
    <title>Code coverage report for services/metrics/sender.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">services/metrics</a> sender.js</h1>
        <div class='clearfix'>
...
&nbsp;
    const reqParams = {
      ...
      body: JSON.stringify({
        ...
        userProperties: userId ? <span class="branch-0 cbranch-no" title="branch not covered" >{ ...anonymousUserProperties, ...payload.userProperties } </span>: {},
        groupProperties: {
          ...anonymousGroupProperties,
          projectType: strapi.EE ? <span class="branch-0 cbranch-no" title="branch not covered" >'Enterprise' </span>: 'Community',
