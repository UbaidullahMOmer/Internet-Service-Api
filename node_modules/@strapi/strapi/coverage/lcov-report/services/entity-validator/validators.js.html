...
<head>
    <title>Code coverage report for services/entity-validator/validators.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">services/entity-validator</a> validators.js</h1>
        <div class='clearfix'>
...
const enumerationValidator = ({ attr }) =&gt; {
  return yup.string().oneOf((Array.isArray(attr.enum) ? attr.enum : <span class="branch-1 cbranch-no" title="branch not covered" >[attr.enum])</span>.concat(null));
};
&nbsp;
...
module.exports = {
  ...
  boolean: () =&gt; yup.boolean(),
  uid: uidValidator,
  json: <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >yup.mixed(),</span>
