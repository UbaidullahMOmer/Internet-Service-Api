...
<head>
    <title>Code coverage report for services/entity-validator/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">services/entity-validator</a> index.js</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">91.33% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>137/150</span>
            </div>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (
    ...
    (<span class="branch-1 cbranch-no" title="branch not covered" >attr.required </span>|| (<span class="branch-2 cbranch-no" title="branch not covered" >Array.isArray(updatedAttribute.value) </span>&amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >updatedAttribute.value.length &gt; 0)</span>)
  ) {
<span class="cstat-no" title="statement not covered" >    nextValidator = nextValidator.min(attr.min);</span>
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (Number.isInteger(attr.max)) {
<span class="cstat-no" title="statement not covered" >    nextValidator = nextValidator.max(attr.max);</span>
  }
...
const addRequiredValidation = (createOrUpdate) =&gt; {
  return (validator, { attr: { required } }) =&gt; {
    ...
    if (required) {
      ...
      } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="else path not taken" >E</span>if (createOrUpdate === 'update') {</span>
<span class="cstat-no" title="statement not covered" >        nextValidator = nextValidator.notNull();</span>
      }
    } else {
...
<span class="cstat-no" title="statement not covered" >      throw new Error('Validation failed: Model not found');</span>
    }
&nbsp;
    if (prop('repeatable', attr) === true) {
      ...
      validator = addRequiredValidation(createOrUpdate)(validator, {
        attr: { required: !isDraft &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >attr.required </span>},
      });
    }
&nbsp;
    return validator;
...
&nbsp;
        return model
          ...
          : <span class="branch-1 cbranch-no" title="branch not covered" >schema;</span>
      })
    );
    validator = addRequiredValidation(createOrUpdate)(validator, { attr: { required: true } });
    validator = addMinMax(validator, { attr, updatedAttribute });
...
const createModelValidator =
  ...
  ({ model, data, entity }, options) =&gt; {
    const writableAttributes = model ? getWritableAttributes(model) : <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
&nbsp;
...
const createValidateEntity =
  ...
  async (model, data, { isDraft = false } = {}, entity = null) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!isObject(data)) {
      const { displayName } = <span class="cstat-no" title="statement not covered" >model.info;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      throw new ValidationError(</span>
...
const buildRelationsStore = ({ uid, data }) =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!uid) {
<span class="cstat-no" title="statement not covered" >    throw new ValidationError(`Cannot build relations store: "uid" is undefined`);</span>
  }
&nbsp;
  if (isEmpty(data)) {
    return {};
...
&nbsp;
    switch (attribute.type) {
      case 'relation':
      case 'media': {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (attribute.relation === 'morphToMany' || attribute.relation === 'morphToOne') {
...
&nbsp;
        ...
        if (Array.isArray(value)) {
          ...
          source = value.connect ?? value.set ?? <span class="branch-2 cbranch-no" title="branch not covered" >[];</span>
        } else {
...
&nbsp;
      ...
      case 'component': {
        return castArray(value).reduce((relationsStore, componentValue) =&gt; {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!attribute.component) {
<span class="cstat-no" title="statement not covered" >            throw new ValidationError(</span>
...
&nbsp;
          return mergeWith(
            ...
            (objValue, srcValue) =&gt; {
              <span class="missing-if-branch" title="if path not taken" >I</span>if (isArray(objValue)) {
<span class="cstat-no" title="statement not covered" >                return objValue.concat(srcValue);</span>
      ...
      case 'dynamiczone': {
        return value.reduce((relationsStore, dzValue) =&gt; {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!dzValue.__component) {
<span class="cstat-no" title="statement not covered" >            throw new ValidationError(</span>
 ...
 * mentioned exists
 */
const checkRelationsExist = async (relationsStore = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> =&gt; {
  const promises = [];
&nbsp;
