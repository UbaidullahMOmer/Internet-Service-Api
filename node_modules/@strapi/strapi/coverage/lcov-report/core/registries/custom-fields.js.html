...
<head>
    <title>Code coverage report for core/registries/custom-fields.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">core/registries</a> custom-fields.js</h1>
        <div class='clearfix'>
...
&nbsp;
    ...
    add(customField) {
      const customFieldList = Array.isArray(customField) ? <span class="branch-0 cbranch-no" title="branch not covered" >customField </span>: [customField];
&nbsp;
