...
<head>
    <title>Code coverage report for commands/admin-create.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">commands</a> admin-create.js</h1>
        <div class='clearfix'>
...
const promptQuestions = [
  {
    ...
    name: 'email',
    message: 'Admin email?',
<span class="fstat-no" title="function not covered" >    as</span>ync validate(value) {
      const validEmail = <span class="cstat-no" title="statement not covered" >await emailValidator.validate(value);</span>
<span class="cstat-no" title="statement not covered" >      return validEmail === value || validEmail;</span>
    },
  },
  {
    type: 'password',
...
<span class="fstat-no" title="function not covered" >    as</span>ync validate(value) {
      const validPassword = <span class="cstat-no" title="statement not covered" >await passwordValidator.validate(value);</span>
<span class="cstat-no" title="statement not covered" >      return validPassword === value || validPassword;</span>
    },
  },
