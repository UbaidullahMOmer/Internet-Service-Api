...
<head>
    <title>Code coverage report for commands/generate-template.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">commands</a> generate-template.js</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >      console.error(`${chalk.red('error')}: ${error.message}`);</span>
    }
  }
}
&nbsp;
