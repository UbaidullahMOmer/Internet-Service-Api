...
<head>
    <title>Code coverage report for lib/hooks.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> hooks.js</h1>
        <div class='clearfix'>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    de</span>lete(handler) {
<span class="cstat-no" title="statement not covered" >      state.handlers = remove(eq(handler), state.handlers);</span>
&nbsp;
 ...
 */
const createAsyncBailHook = <span class="fstat-no" title="function not covered" >()</span> =&gt; (<span class="cstat-no" title="statement not covered" >{</span>
  ...createHook(),
&nbsp;
<span class="fstat-no" title="function not covered" >  as</span>ync call(context) {
<span class="cstat-no" title="statement not covered" >    for (const handler of this.getHandlers()) {</span>
      const result = <span class="cstat-no" title="statement not covered" >await handler(context);</span>
&nbsp;
