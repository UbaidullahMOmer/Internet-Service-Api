...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> async.js</h1>
        <div class='clearfix'>
 ...
 */
const forEachAsync = curry(<span class="fstat-no" title="function not covered" >as</span>ync (array, func, options) =&gt; {
<span class="cstat-no" title="statement not covered" >  await mapAsync(array, func, options);</span>
});
&nbsp;
module.exports = {
  mapAsync,
