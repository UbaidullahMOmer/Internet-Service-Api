...
<head>
    <title>Code coverage report for lib/pagination.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> pagination.js</h1>
        <div class='clearfix'>
...
&nbsp;
const withMaxLimit = (limit, maxLimit = <span class="branch-0 cbranch-no" title="branch not covered" >-1)</span> =&gt; {
...
const ensureMaxValues =
  (maxLimit = <span class="branch-0 cbranch-no" title="branch not covered" >-1)</span> =&gt;
  ({ start, limit }) =&gt; ({
    start,
...
const withNoLimit = (pagination, maxLimit = <span class="branch-0 cbranch-no" title="branch not covered" >-1)</span> =&gt; ({
  ...pagination,
  limit: pagination.limit === -1 ? maxLimit : pagination.limit,
});
&nbsp;
const withDefaultPagination = (args, { defaults = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> maxLimit = -1 } = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> =&gt; {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (usePagePagination &amp;&amp; useOffsetPagination) {
<span class="cstat-no" title="statement not covered" >    throw new PaginationError('Cannot use both page &amp; offset pagination in the same query');</span>
  }
&nbsp;
  const pagination = {};
&nbsp;
